...
class DirectiveTest extends TestCase
{
  ...
  public function setUp(): void
  {
    ...
    $this->compiler->directive('navigare', [Directive::class, 'compile']);
    $this->compiler->directive('navigareHead', [
      Directive::class,
      'compileHead',
    ]);
  }
  ...
  protected function renderView($contents, $data = [])
  {
    ...
    $path = tempnam(sys_get_temp_dir(), 'navigare_tests_render_');
    ...
    $view
      ->getFactory()
      ->allows('decrementRender')
      ->once();
    $view
      ->getFactory()
      ->allows('flushStateIfDoneRendering')
      ->once();
  ...
  public function test_navigare_directive_renders_the_root_element(): void
  {
    $html =
      '<div id="app" data-page="{&quot;component&quot;:&quot;Foo\/Bar&quot;,&quot;props&quot;:{&quot;foo&quot;:&quot;bar&quot;},&quot;url&quot;:&quot;\/test&quot;,&quot;version&quot;:&quot;&quot;}"></div>';

    $this->assertSame(
      $html,
      $this->renderView('@navigare', ['page' => self::EXAMPLE_PAGE_OBJECT])
    );
    $this->assertSame(
      $html,
      $this->renderView('@navigare()', ['page' => self::EXAMPLE_PAGE_OBJECT])
  ...
  public function test_navigare_directive_renders_server_side_rendered_content_when_enabled(): void
  {
    Config::set(['navigare.ssr.enabled' => true]);
  ...
  public function test_navigare_directive_can_use_a_different_root_element_id(): void
  {
    $html =
      '<div id="foo" data-page="{&quot;component&quot;:&quot;Foo\/Bar&quot;,&quot;props&quot;:{&quot;foo&quot;:&quot;bar&quot;},&quot;url&quot;:&quot;\/test&quot;,&quot;version&quot;:&quot;&quot;}"></div>';

    $this->assertSame(
      $html,
      $this->renderView('@navigare(foo)', ['page' => self::EXAMPLE_PAGE_OBJECT])
    );
    $this->assertSame(
      $html,
      $this->renderView("@navigare('foo')", [
        'page' => self::EXAMPLE_PAGE_OBJECT,
      ])
    );
    $this->assertSame(
      $html,
  ...
  public function test_navigare_head_directive_renders_nothing(): void
  {
    $this->assertEmpty(
      $this->renderView('@navigareHead', ['page' => self::EXAMPLE_PAGE_OBJECT])
    );
  }

  public function test_navigare_head_directive_renders_server_side_rendered_head_elements_when_enabled(): void
  {
    Config::set(['navigare.ssr.enabled' => true]);
